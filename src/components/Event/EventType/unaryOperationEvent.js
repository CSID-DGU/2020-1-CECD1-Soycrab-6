...
import OperandVar from '../Partial/OperandVar';
import Operator from '../Partial/Operator';

function unaryOperationEvent({ event }) {
...
export default unaryOperationEvent;
